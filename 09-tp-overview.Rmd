...
```{r tipping-schematic, echo=FALSE, fig.cap="Schematic of a climate tipping transition, following the tipping-point definition of Lenton et al. (2008)."}
...
regional_impact <- data.frame(
  Element = c("Low-latitude Coral Reefs", "Boreal Permafrost",
              ...
              "Sahel & West African Monsoon", "Boreal Forest (south)",
              "Boreal Forest (north)"),
...
```{r ews-plot, echo=FALSE, fig.cap="Reproduced variance and AC1 trends for the Central-Western Greenland melt record, following the method of Boers & Rypdal (2021)."}
