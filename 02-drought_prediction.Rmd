...
A fixed mask marks the valid Alpine cells.
...
These capture large-scale drivers of European moisture and its seasonality, with the fourteen Mediterranean basins grouped into three regional means (western Mediterranean, eastern Mediterranean, Black Sea) [@millotCirculationMediterraneanSea2005; @lionelloMediterraneanClimateOverview2006].
...
The average severe-drought frequency rises across them, from 0.53 to 0.62 to 1.04 events per cell per year, so the test period is both out of sample and drier than the training period.
