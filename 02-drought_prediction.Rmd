...
A fixed mask marks the valid Alpine cells, shown outlined against the surrounding European topography in Figure \@ref(fig:dp-al-topography).

```{r dp-al-topography, echo=FALSE, fig.cap="Topography over Europe. The red outline marks the Alpine study domain.", out.width="70%", fig.align="center"}
...
```{r dp-spei-snapshots, echo=FALSE, fig.cap="SPEI over the Alpine domain across 1971.", out.width="100%", fig.align="center"}
dp_img("work/02-drought_prediction/figures/raw/al/spei.svg")
```

```{r dp-med-slt, echo=FALSE, fig.cap="Mediterranean SST, 1971--2024, aggregated into three regional groups (western Mediterranean, eastern Mediterranean, Black Sea).", out.width="100%", fig.align="center"}
...
```{r dp-convlstm-schematic, echo=FALSE, fig.cap="(ref:dp-convlstm-schematic-cap)", out.width="75%", fig.align="center"}
...
```{r dp-naive-vs-film, echo=FALSE, fig.cap="(ref:dp-naive-vs-film-cap)", out.width="90%", fig.align="center"}
...
```{r dp-convlstm-film, echo=FALSE, fig.cap="(ref:dp-convlstm-film-cap)", out.width="75%", fig.align="center"}
...
```{r dp-naive-vs-static-encoder, echo=FALSE, fig.cap="Static spatial feature injection strategies. Naive injection is on the left and the learned encoder on the right (single and seasonal variants).", out.width="90%", fig.align="center"}
...
```{r dp-convlstm-static, echo=FALSE, fig.cap="(ref:dp-convlstm-static-cap)", out.width="75%", fig.align="center"}
