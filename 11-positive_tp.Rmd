```{r positive-tp-setup, include=FALSE}
...
```{r benchmarkcontext, fig.cap="Historical electricity transitions in Denmark and the United Kingdom. Coal is displayed separately for the United Kingdom.", fig.width=10, fig.height=8}
...
```{r maincontext, fig.cap="Annual fossil and wind and solar shares of electricity generation in Spain, Germany and Poland from 2000 to 2025.", fig.width=10, fig.height=8}
...
```{r spainscurve, fig.cap="Observed and fitted wind and solar electricity shares in Spain. The shaded area is the residual bootstrap band. Dashed curves use alternative saturation assumptions.", fig.width=10, fig.height=6}
spain_scurve_plot
```
...
```{r germanyscurve, fig.cap="Observed and fitted wind and solar electricity shares in Germany. The fitted inflection occurs near the end of the observed period.", fig.width=10, fig.height=6}
germany_scurve_plot
```
...
```{r polandscurve, fig.cap="Observed and fitted wind and solar electricity shares in Poland. The fitted inflection occurs after the observed period.", fig.width=10, fig.height=6}
poland_scurve_plot
```
...
```{r fossilcontext, fig.cap="Aggregate fossil electricity shares and fitted wind and solar inflection years in Spain, Germany and Poland.", fig.width=10, fig.height=8}
fossil_context_plot
```
...
```{r ewsar, fig.cap="Rolling lag one autocorrelation of monthly fossil-share residuals. Vertical blue lines indicate the fitted wind and solar inflection dates.", fig.width=10, fig.height=8}
ews_ar_plot
```
...
```{r ewsvariance, fig.cap="Rolling variance of monthly fossil-share residuals. Vertical blue lines indicate the fitted wind and solar inflection dates.", fig.width=10, fig.height=8}
ews_variance_plot
```
