...
fraenkische_saale_salz <- read.csv("Water_Temp/Fraenkische_Saale_Salz.csv")
fraenkische_saale_wolfsmuenster <- read.csv("Water_Temp/Fraenkische_Saale_Wolfsmuenster.csv")
Itz_schenkenau <- read.csv("Water_Temp/Itz_Schenkenau.csv")
main_frankfurt_osthafen <- read.csv("Water_Temp/main_frankfurt_osthafen.csv")
main_kemmern <- read.csv("Water_Temp/main_kemmern.csv")
main_kleinheubach <- read.csv("Water_Temp/main_kleinheubach.csv")
main_krotzenburg <- read.csv("Water_Temp/main_krotzenburg.csv")
main_mainleus <- read.csv("Water_Temp/main_mainleus.csv")
main_schweinfurt <- read.csv("Water_Temp/main_schweinfurt.csv")
main_schwuerbitz <- read.csv("Water_Temp/main_schwuerbitz.csv")
main_steinbach <- read.csv("Water_Temp/main_steinbach.csv")
main_wuerzburg <- read.csv("Water_Temp/main_wuerzburg.csv")
regnitz_pettstadt <- read.csv("Water_Temp/regnitz_pettstadt.csv")
wern_sachsenheim <- read.csv("Water_Temp/wern_sachsenheim.csv")
