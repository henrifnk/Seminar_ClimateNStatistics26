...
Usage:
    python -m downscaling.data_prep.coarsen_cerra
"""
...
REANALYSIS_DIR = Path("data") / "reanalysis"
MBCN_REF       = Path("data") / "projection" / "pr_mbcn_daily_1996-2000.nc"
OUTDIR         = Path("data") / "reanalysis_coarsened"
