...
Usage:
    python -m downscaling.inference.Inference cerra 2019-01-05 [--borders]
    python -m downscaling.inference.Inference mbcn  2091-07-15 [--borders]
"""
import argparse
import os
...
from downscaling import wm2024model
from downscaling.DatasetAL import doy_hour_label
from downscaling.grids import OUTPUT_SIZE, compute_cerra_grid
from downscaling.paths import plot_dir
from downscaling.sampling import sample_once
...
if os.path.exists(_NORM_FILE):
    ...
    raise FileNotFoundError(
        ...
        "Run: python -m downscaling.training.ComputeNormStats")
# ──────────────────────────────────────────────────────────────────────────────
