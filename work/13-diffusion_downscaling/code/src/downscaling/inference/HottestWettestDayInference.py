...
Usage:
    python -m downscaling.inference.HottestWettestDayInference
    python -m downscaling.inference.HottestWettestDayInference --checkpoint ./model/20.pt --n 4
    python -m downscaling.inference.HottestWettestDayInference --start-year 2001 --end-year 2020
...
from downscaling.DatasetAL import doy_hour_label
from downscaling.evaluation.EnsembleInference import run_ensemble
from downscaling.evaluation.ProjectionPeriodAssessment import load_setup, prep_mbcn_date
from downscaling.grids import compute_cerra_grid
from downscaling.inference.Inference import CERRA_REF, DATADIR_PROJECTION, find_mbcn_file
from downscaling.paths import INFERENCE_DIR
