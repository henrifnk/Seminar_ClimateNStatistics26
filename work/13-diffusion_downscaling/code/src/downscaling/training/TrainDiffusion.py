...
Biases. Normalization statistics are written to data/norm_stats.npz as a side effect —
...
Usage:
    python -m downscaling.training.TrainDiffusion
"""
import copy
import os
...
from downscaling.DatasetAL import UpscaleDataset, save_norm_stats
from downscaling.paths import TRAINING_DIR
...
def generate_sample(model, dataloader, num_steps=40, sigma_min=0.002,
    ...
    # zip() pairs consecutive sigmas: (σ_0,σ_1), (σ_1,σ_2), ..., (σ_min, 0)
    for i, (t_cur, t_next) in enumerate(zip(t_steps[:-1], t_steps[1:])):
        ...
        # increase variance of x from t_cur² to t_hat² by adding the exact missing noise
