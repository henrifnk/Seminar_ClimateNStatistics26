...
Usage:
    python -m downscaling.evaluation.ProjectionPeriodAssessment --checkpoint ./model/20.pt
    python -m downscaling.evaluation.ProjectionPeriodAssessment --checkpoint ./model/20.pt --n-clim 4 --stride 10 --cache-dir ./cache
"""
import argparse
import os
...
from downscaling.evaluation.EnsembleInference import DEVICE, cache_tag, compute_cerra_grid, load_model, run_ensemble
from downscaling.evaluation.ProjectionPlots import (
    GWL_PERIODS,
    OUT_DIR,
    _cache_slug,
    _plot_delta,
...
from downscaling.inference.Inference import (
    CERRA_REF,
    DATADIR_PROJECTION,
    OUTPUT_SIZE,
    build_interpolator,
...
def _run_hottest_wettest(setup, args):
    ...
    from downscaling.inference.HottestWettestDayInference import (
