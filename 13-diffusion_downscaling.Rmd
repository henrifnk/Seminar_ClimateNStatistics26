...
@lopezgomez2025 gave the model additional context, e.g. a surface pressure climate field, for downscaling precipitation.
...
```{r quantile-delta, echo=FALSE, fig.cap="Distribution shift relative to PRESENT, by percentile and global warming level. Left: temperature, right: precipitation; the dashed line marks no change.", out.width="100%", fig.align="center"}
...
Generative AI tools were utilized as an aid for researching relevant literature, for improving spelling and grammar, and for adapting the code used for the analyses and models.
