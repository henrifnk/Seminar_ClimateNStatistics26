...
Therefore, the projection assessment is limited to a consistency check between the interpolation climate field and the downscaled high-resolution climate fields,
...
the maximum pixel value increases substantially relative to the interpolated field by +28.70 mm/day. The interpolation had removed part of that peak
beforehand (-7.08 mm/day). Thus, a part of the increase only restores the peak that the smoothing had removed. The downscaled maximum is still 11.7 % above the native 12 km maximum.
...
max_day <- data.frame(
  ...
  d_model    = c("-0.07", "+1.28", "+0.03", "+28.70")
)
...
For precipitation only the tail of the distribution is affected. Up to roughly the 80th percentile the values stay unchanged, beyond the 90th percentile they increase to about
