...
kbl(
  ...
  row_spec(0, bold = TRUE, background = "#3f3f3f", color = "white")
```
```{r error-prone-areas, echo=FALSE, fig.cap="Mean absolute error of the ensemble mean over the Alpine domain, in °C and mm/day.", out.width="100%", fig.align="center"}
...
The native 12 km field is mapped onto the fine grid by a nearest-neighbor lookup. Thus, all three fields share one grid.
...
The interpolation-residual setup produces realistic fine-scaled temperature fields over the Alpine domain, though the ensemble remains underdispersed. For precipitation further improvements are necessary.
