...
```{r regional-jja-warming, echo=FALSE, fig.cap="Regional JJA warming across the three future periods. Gray lines show model-specific forced responses, while the highlighted line shows the equal-model-weighted multi-model mean.", out.width="120%", fig.align="center"}
...
```{r model-forced-response, echo=FALSE, fig.cap="Model-specific forced regional JJA warming responses across the three study regions and future periods.", out.width="120%", fig.align="center"}
...
```{r internal-variability, echo=FALSE, fig.cap="Internal variability in 20-year mean regional JJA warming across regions and future periods.", out.width="65%", fig.align="center"}
...
```{r model-uncertainty, echo=FALSE, fig.cap="Model uncertainty in regional JJA warming across regions and future periods.", out.width="65%", fig.align="center"}
...
```{r uncertainty-decomposition, echo=FALSE, fig.cap="Relative contributions of internal variability and model uncertainty to total fixed-scenario projection variance.", out.width="80%", fig.align="center"}
...
```{r total-uncertainty, echo=FALSE, fig.cap="Total fixed-scenario projection uncertainty, expressed as standard deviation, across regions and future periods.", out.width="50%", fig.align="center"}
...
```{r total-snr, echo=FALSE, fig.cap="Total signal-to-noise ratios for regional JJA warming across regions and future periods.", out.width="65%", fig.align="center"}
...
```{r internal-snr, echo=FALSE, fig.cap="Internal signal-to-noise ratios for regional JJA warming across regions and future periods.", out.width="65%", fig.align="center"}
...
The mid-century distributions help explain these regional differences (Figure \@ref(fig:mid-century-threshold-distributions)). In NEU, much of the model-member distribution remains below the $2^\circ\mathrm{C}$ threshold, whereas larger shares of the WCE and MED distributions lie above it. The $3^\circ\mathrm{C}$ threshold remains in the upper part of all three distributions. Mid-century therefore provides a clear example of how the position of a threshold relative to both the center and spread of a distribution affects exceedance probability.

```{r mid-century-threshold-distributions, echo=FALSE, fig.cap="Mid-century model-member distributions of regional 20-year mean JJA warming relative to the 2°C and 3°C thresholds.", out.width="100%", fig.align="center"}
...
```{r appendix-internal-sd, echo=FALSE, fig.cap="Regional and temporal comparison of internal standard deviation in 20-year mean JJA warming.", out.width="70%", fig.align="center"}
knitr::include_graphics("work/01-climate_uncertainty/figures/fig12_regional_temporal_internal_sd.svg")
```

```{r appendix-total-sd, echo=FALSE, fig.cap="Regional and temporal comparison of total fixed-scenario projection standard deviation.", out.width="70%", fig.align="center"}
knitr::include_graphics("work/01-climate_uncertainty/figures/fig13_regional_temporal_total_sd.svg")
```

```{r appendix-snr-threshold, echo=FALSE, fig.cap="Relationship between Total SNR and Threshold Exceedance Probability.", out.width="100%", fig.align="center"}
knitr::include_graphics("work/01-climate_uncertainty/figures/fig15a_threshold_centered_snr_exceedance_probability.svg")
```
