...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig01_study_region_map.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig02_regional_jja_warming_timeseries.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig03_model_forced_response.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig04_internal_variability.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig05_model_uncertainty.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig06_uncertainty_decomposition.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig07_total_uncertainty_heatmap.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig08_warming_distribution_prediction_ranges.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig09_total_snr.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig10_internal_snr.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig11_threshold_exceedance_probability.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig15b_mid_century_warming_distribution_thresholds.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig16_bootstrap_ci_uncertainty_metrics.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig17_bootstrap_ci_snr_threshold_probability.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig18_balanced_20_member_sensitivity.png")
```
...
master_summary <- master_summary[, c(
  "region",
  "period",
  "Mean warming (°C)",
  "Total SD (°C)",
...
uncertainty_magnitudes <- uncertainty_magnitudes[, c(
  "region",
  "period",
  "Internal variance (°C²)",
  "Internal SD (°C)",
...
prediction_ranges <- prediction_ranges[, c(
  "region",
  "period",
  "Mean warming (°C)",
  "Q05 (°C)",
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig12_regional_temporal_internal_sd.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig13_regional_temporal_total_sd.png")
```
...
knitr::include_graphics("work/01-climate_uncertainty/figures/fig15a_threshold_centered_snr_exceedance_probability.png")
```
...
balanced_comparison <- balanced_comparison[, c(
  "region",
  "period",
  "Full total SD",
  "Balanced total SD",
