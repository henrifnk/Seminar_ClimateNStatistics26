...
![Example time series from the five simulation scenarios.](work/08-uncertainty_tp/figures/01_example_time_series.png){#fig:utp-example-time-series}
...
![Rolling early-warning indicators across the simulation scenarios.](work/08-uncertainty_tp/figures/02_rolling_indicators.png){#fig:utp-rolling-indicators}
...
![ROC curves for variance, AC1, and the combined early-warning indicator.](work/08-uncertainty_tp/figures/03_roc_auc.png){#fig:utp-roc-auc}
...
![Frequency of detected warning signals across simulation scenarios.](work/08-uncertainty_tp/figures/04_signal_rates_by_scenario.png){#fig:utp-signal-rate}
...
![Posterior tipping probability after observing an early-warning signal under different prior probabilities.](work/08-uncertainty_tp/figures/05_bayesian_posterior.png){#fig:utp-bayesian-posterior}
