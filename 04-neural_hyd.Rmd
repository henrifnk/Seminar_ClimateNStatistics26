...
temperature seasonality, and snowmelt timing all shift over time [@ipcc2021carbon].
...
source("work/04-neural_hyd/code/nh-transfer-setup.R", local = knitr::knit_global())
```
